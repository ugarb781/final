...
function changeBackClothes(){
  if (document.getElementById("hoodie").src !== "Masons_Project/GRAPHICS/Men's/R_Zucc.png"){
    document.getElementById("hoodie").src ="Masons_Project/GRAPHICS/Men's/R_Zucc.png";
  }
  if (document.getElementById("sweater").src !== "Masons_Project/GRAPHICS/Men's/O_Snake.PNG"){
    document.getElementById("sweater").src ="Masons_Project/GRAPHICS/Men's/O_Snake.PNG";
  }
  if (document.getElementById("buckethat").src !=="Masons_Project/GRAPHICS/Men's/BBH.PNG"){
    document.getElementById("buckethat").src ="Masons_Project/GRAPHICS/Men's/BBH.PNG";
  }
}
...
function greenHoodie(){
    document.getElementById("hoodie").src ="Masons_Project/GRAPHICS/Men's/L_Zucc.png";
  }
function redHoodie(){
   document.getElementById("hoodie").src ="Masons_Project/GRAPHICS/Men's/R_Zucc.png";
}
...
function blackHoodie(){
  document.getElementById("hoodie").src ="Masons_Project/GRAPHICS/Men's/B_Zucc.png";
}
...
function whiteHat(){
  document.getElementById("buckethat").src ="Masons_Project/GRAPHICS/Men's/WBH.PNG";
  console.log('working');
}
...
function blueSweater(){
  document.getElementById("sweater").src ="Masons_Project/GRAPHICS/Men's/B_Snake.PNG";
}
